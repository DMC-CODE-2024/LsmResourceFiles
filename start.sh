...
module_name="eir_list_sync"
main_module="eir" #keep it empty "" if there is no main module 
...
#java -Dlog4j.configurationFile=./log4j2.xml -Dspring.config.location=file:./application.yml -jar eirs-fcm.jar  1>> ${LOG_HOME}/eir_module/fcm/fcm-logs.txt 2>&1 & 
